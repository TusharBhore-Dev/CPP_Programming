...
/*
    ...
    START
        ...
        Display a right-angled triangle pattern where each row contains the row number repeated, using nested for loops
    STOP
*/
...
class Pattern
{
    ...
    int iRow = 0 , iCol = 0 , i = 0 , j = 0;
            ...
            void DisplayPattern()
            {
                ...
                for( i = 1; i <= iRow; i++ )
                {
                    // Inner loop handles printing the row number 'i' repeatedly up to row count
                    for( j = 1; j <= i; j++ )
                    {
