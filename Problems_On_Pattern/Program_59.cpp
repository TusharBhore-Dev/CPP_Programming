...
/*
    ...
    START
        ...
        Display an inverted right-angled triangle star pattern using nested while loops
    STOP
*/
...
//
//  Class Name : Pattern
//  Description : It is used to display the inverted triangular star pattern
    ...
    int iRow = 0 , iCol = 0 , i = 0 , j = 0;
            ...
            void DisplayPattern()
            {
                ...
                while( i <= iRow )
                {
                    ...
                    // The limit (iCol + 1 - i) ensures the number of stars decreases as 'i' increases
                    while( j <= ( ( iCol + 1 ) - i ) )
                    {
...
//
//  Input : 4 4     Output : Inverted triangle with 4 rows
//  Input : 3 3     Output : Inverted triangle with 3 rows
