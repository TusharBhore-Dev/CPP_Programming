...
/*
    ...
    START
        ...
        Display a square pattern with borders and a diagonal using conditional logic in nested while loops
    STOP
*/
...
//
//  Class Name : Pattern
//  Description : It is used to display the hollow square pattern with a diagonal
    ...
    int iRow = 0 , iCol = 0 , i = 0 , j = 0 ;
            ...
            void DisplayPattern()
            {
                ...
                while( i <= iRow )
                {
                    ...
                    while( j <= iCol )
                    {
                        // Check boundary conditions and diagonal condition (j == i)
                        // If true, print star; otherwise, print space
                        if ( i == 1 || j == 1 || j == i || j == iCol || i == iRow )
                        {
                            cout<<"*\t";
                        }
                        else
...
//
//  Input : 5 5     Output : 5x5 Square with hollow center and diagonal
//  Input : 3 3     Output : 3x3 Square with hollow center and diagonal
